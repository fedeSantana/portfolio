    ...
    <div className="navbar">
      <div className="navbar__main-menu">
        <a className="navbar__logo" href="./">
          <svg
            className="styles__StyledHeart-yo7v04-4 kOAlxn"
            role="img"
            width="23"
            height="21"
            viewBox="0 0 23 21"
        ...
        >
          <ul className="main-menu__list" id="primary-navigation">
            <li className="main-menu__item">
              <a className="main-menu__link main-menu__link--emp1">
                {" "}
                contacto{" "}
              </a>
            </li>
            <li className="main-menu__item">
              <a
                className="main-menu__link main-menu__link--emp2"
                href="google.com"
              >
                acerca de mí
              </a>
